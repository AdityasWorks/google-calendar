...
export async function GET(
  ...
  try {
    ...
    const event = await getEventById(eventId, CURRENT_USER_ID);
...
export async function PUT(
  ...
  try {
    ...
    const updatedEvent = await updateEvent(eventId, CURRENT_USER_ID, updates);
...
export async function DELETE(
  ...
  try {
    ...
    const success = await deleteEvent(eventId, CURRENT_USER_ID);
